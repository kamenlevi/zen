...
const Board: React.FC<BoardProps> = ({ boardState, selectedCell, onCellSelect, highlightedValue }) => {
  ...
  return (
    <div className="flex items-center justify-center w-full px-1">
      <div className="w-full max-w-[min(98vw,460px,65vh)] aspect-square bg-zinc-900 grid grid-cols-9 grid-rows-9 p-[1px] rounded-2xl shadow-2xl border-[2px] border-zinc-900 overflow-hidden">
