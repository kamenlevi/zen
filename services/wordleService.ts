...
export async function isValidWord(word: string): Promise<boolean> {
  ...
  try {
    const apiCall = ai.models.generateContent({
      ...
      contents: `Is the 5-letter string "${w}" a valid English word? Return ONLY JSON: {"valid": boolean}`,
